...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 37, 50, 350, 500, provider);
		...
		// creating map2
		map2 = new UnfoldingMap(this, 413, 50, 350, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(32.6469443,-117.0274971));
