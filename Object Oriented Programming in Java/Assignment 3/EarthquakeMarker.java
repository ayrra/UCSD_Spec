...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	//draws an X over any earthquake within the past day
	private void pastDayQuake(PGraphics pg, float x, float y) {
		float radius = scaledRadius();
		String age = getAge();
		//we need 2 separate draws depending on circle or square
	...
	public float scaledRadius() {
		 return (float) (Float.parseFloat(getProperty("radius").toString()) * 1.2);
	}
